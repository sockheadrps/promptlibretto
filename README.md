...
Design rationale: [`PROMPT_ENGINE_DESIGN.md`](PROMPT_ENGINE_DESIGN.md).
Browser test bench: [`test-bench` branch](https://github.com/sockheadrps/PromptEngine/tree/test-bench).
